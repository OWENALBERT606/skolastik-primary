...
export const metadata: Metadata = buildMetadata({
  title: "Sign In — Skolastik School Solutions",
  description: "Sign in to your Skolastik school management account. Access your school dashboard, manage academics, fees, report cards, timetables, and more.",
  path: "/",
  keywords: ["school management", "login", "sign in", "education platform", "Uganda schools", "academic management", "fee management"],
});
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "WebPage",
    name: "Sign In — Skolastik School Solutions",
    description: "Sign in to your Skolastik school management account.",
    url: "https://skolastik.com/",
    publisher: {
      "@type": "Organization",
      name: "Skolastik School Solutions",
      logo: {
        "@type": "ImageObject",
        url: "https://skolastik.com/sckola.png",
      },
    },
  };
